...
public class Sideralis extends Activity {
    ...
    protected Dialog onCreateDialog(int id) {
        ...
        case PROGRESS_DIALOG:
            ...
            progressDialog.setMessage("Sideralis is starting.\nPlease wait...");
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case MENU_SETTING_DATE:
			...
			dpDialog = new DatePickerDialog(this,datePickerCallBack,
					myPosition.getTemps().getDate().get(Calendar.YEAR),
					myPosition.getTemps().getDate().get(Calendar.MONTH),
					myPosition.getTemps().getDate().get(Calendar.DAY_OF_MONTH));
			dpDialog.show();
			return true;
		...
		case MENU_SETTING_TIME:
			...
			tpDialog = new TimePickerDialog(this,timePickerCallBack,
					myPosition.getTemps().getDate().get(Calendar.HOUR_OF_DAY),
					myPosition.getTemps().getDate().get(Calendar.MINUTE),true);
			tpDialog.show();
			return true;
